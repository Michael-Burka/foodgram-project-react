    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким username уже существует.'}, help_text='введите username', max_length=150, unique=True, validators=[users.validators.validate_username], verbose_name='Ваш логин')),
                ('email', models.EmailField(error_messages={'unique': 'e-mail уже занят.'}, max_length=254, unique=True, verbose_name='Почта')),
